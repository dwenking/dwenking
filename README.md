...
- **2026 –** · **NVIDIA** · Software Developer
- 2026 · **ByteDance** · SDE Intern
- 2025 · **Amazon** · SDE Intern
- 2025 · **Alibaba Cloud** · Research Intern
- 2021, 2022 · **Microsoft** · SDE Intern

### 01 EXPERIENCE

<details><summary><b>NVIDIA / 2026 –</b> — Full-stack development on an internal engineering planning platform.</summary>

`Java` `Spring Boot` `Vue` `MongoDB` `Redis`
</details>
...
`AWS` `Lambda` `SQS` `DynamoDB` `Agent SDK` `MCP` `OpenTelemetry`
